        ...
        <div class="country-badge bg-white rounded-xl shadow-md border border-gray-200 p-3 sm:p-4 hover:shadow-lg transition-all duration-300 transform hover:scale-105">
            ...
            <div class="grid grid-cols-2 gap-2 sm:gap-3 text-xs sm:text-sm mb-2 sm:mb-3">
                ...
                <div class="flex items-center justify-between bg-green-50 rounded-lg p-2">
                    <span class="text-gray-600">체류:</span>
                ...
                <div class="flex items-center justify-between bg-purple-50 rounded-lg p-2">
                    <span class="text-gray-600">평균:</span>
                    <span class="font-semibold text-purple-600">${avgStayDays}일</span>
                </div>
                <div class="flex items-center justify-between bg-orange-50 rounded-lg p-2">
            ...
            <div class="mt-2 sm:mt-3 pt-2 sm:pt-3 border-t border-gray-200">
                ...
                <div class="grid grid-cols-2 gap-2 text-xs text-gray-500">
                    ...
                    <div>
                        <strong>최근 방문:</strong><br>
                        <span class="text-gray-600">${lastVisitDate}</span>
                    </div>
                </div>
            </div>
